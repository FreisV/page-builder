...
const SocialNetworksBlock = ({ id, ...otherProps }) => {
  ...
  const facebookBlock = block.facebookLink ? (
    <span className="social-network facebook">
      <svg
  ...
  const instagramBlock = block.instagramLink ? (
    <span className="social-network instagram">
      <svg
        className="social-network_icon"
        width="28px"
        height="28px"
  ...
  const vkBlock = block.vkLink ? (
    <span className="social-network vk">
      <svg
        className="social-network_icon"
        width="28px"
        height="28px"
  ...
  const telegramBlock = block.telegramLink ? (
    <span className="social-network telegram">
      <svg
        className="social-network_icon"
        width="28px"
        height="28px"
